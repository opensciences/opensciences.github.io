...
* [MySQL dump in Terapromise](https://terapromise.csc.ncsu.edu/svn/repo/other/msr14)
...
* A [MySQL database dump](https://terapromise.csc.ncsu.edu/svn/repo/other/msr14) containing a queriable version of important fields extracted from the raw data. See schema below.
