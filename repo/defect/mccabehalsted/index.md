...
For data sets that use the Halstead and McCabe metrics, see end of this page.

For notes on the use of these metris in defect prediction, [see this tutorial](../index.html).
